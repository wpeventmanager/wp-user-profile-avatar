...
<div class="wrap">
    ...
    <form action="" method="post" id="disable-comments">
        <ul>
            ...
            <li><label for="selected-types"><input type="radio" id="selected-types" name="mode" value="selected-types" <?php echo $selected; ?> /> <strong><?php _e('On certain post types', 'disable-comments'); ?></strong>:</label>
                <p></p>
