...
class WPUPA_Author_Social_Profile {
    ...
    public function __construct() {
        ...
        add_action( 'admin_menu', array( $this, 'wpupa_avatar_users_menu' ) );
    ...
    /**
     * Add users page for Avatar Social Picture settings.
     */
    public function wpupa_avatar_users_menu() {
        add_users_page( 'Avatar Social Picture', 'Avatar Social Picture', 'activate_plugins', 'avatar-social-picture', array( $this, 'wpupa_user_admin' ) );
    }
